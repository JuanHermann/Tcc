...
INSERT INTO usuario ( ativo, email, nome, senha, telefone) VALUES (  true, 'julio@adm.com','Julio', 123, '(99) 99123-9119');
INSERT INTO usuario ( ativo, email, nome, senha, telefone) VALUES (  true, 'maria@adm.com','Maria', 123, '(99) 99312-9129');
INSERT INTO usuario ( ativo, email, nome, senha, telefone) VALUES (  true, 'debora@adm.com','Debora', 123, '(99) 99333-6798');
INSERT INTO usuario ( ativo, email, nome, senha, telefone) VALUES ( true, 'roberto@adm.com','Roberto', 123, '(99) 99999-9999');
INSERT INTO usuario ( ativo, email, nome, senha, telefone) VALUES (  true, 'lucas@adm.com','Lucas', 123, '(99) 99999-9999');
INSERT INTO usuario ( ativo, email, nome, senha, telefone) VALUES (  true, 'simone@adm.com','Simone', 123, '(99) 99999-9999');
